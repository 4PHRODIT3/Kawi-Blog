...
<div class="col-12 col-lg-3 col-xl-2 left-side-bar vh-100">
    ...
    <div class="col-12">
        <ul class="nav-menu px-2 ">
            ...
            <li class="nav-item">
                <a href="items_add.html" class="nav-item-link"><span><i class="feather feather-plus-circle"></i> Category List</span></a>
            </li>
            <li class="nav-item">
                <a href="item_list.html" class="nav-item-link">
                    <div class="d-flex justify-content-between align-items-center">
...
<div class="col-12 col-lg-9 col-xl-10 content left-shadow">
    ...
    >
        ...
        <div class="d-flex align-items-center">
            ...
            >
                <img
                src="<?= BASE_URL ?>/assets/icons/icons8-person-48.png"
                alt="Profile Image"
