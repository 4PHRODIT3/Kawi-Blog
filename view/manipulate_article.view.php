                ...
                <div class="card my-3 my-lg-5">
                    ...
                    <div class="card-body">
                        <?php printAlert() ?>
                            ...
                            <div class="form-group">
                                <label class="mb-3" for="duration" >Content Duration</label>
                                <input  type="text" class="form-control" id="duration" required  name="duration" value="<?= $previous_data['duration'] ?>">
                            </div>
                            <div class="form-group">
